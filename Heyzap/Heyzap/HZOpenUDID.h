...
//
// Usage:
//    #include "HZOpenUDID.h"
//    NSString* openUDID = [HZOpenUDID value];
//

#define kHZOpenUDIDErrorNone          0
#define kHZOpenUDIDErrorOptedOut      1
#define kHZOpenUDIDErrorCompromised   2

@interface HZOpenUDID : NSObject {
