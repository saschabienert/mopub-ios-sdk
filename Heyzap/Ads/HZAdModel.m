...
- (BOOL) onClick {
    ...
    [[HZMetrics sharedInstance] logMetricsEvent:@"ad-clicked" value:@1 tag:self.tag type:self.adUnit];
    long timeCLickedMiliseconds = lround([[NSDate date] timeIntervalSince1970] * 1000);
    [[HZMetrics sharedInstance] logMetricsEvent:@"time-clicked" value:@(timeCLickedMiliseconds) tag:self.tag type:self.adUnit];
...
- (BOOL) onImpression {
    ...
    [[HZMetrics sharedInstance] logMetricsEvent:@"creative-id" value:self.creativeID tag:self.tag type:self.adUnit];
    [[HZMetrics sharedInstance] logMetricsEvent:@"impression-id" value:self.impressionID tag:self.tag type:self.adUnit];
