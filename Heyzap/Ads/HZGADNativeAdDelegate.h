...
@protocol HZGADNativeAdDelegate <NSObject>
...
- (void)nativeAdWillDismissScreen:(HZGADNativeAd *)nativeAd;
...
- (void)nativeAdDidDismissScreen:(HZGADNativeAd *)nativeAd;
