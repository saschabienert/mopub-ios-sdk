...
@property (nonatomic, unsafe_unretained) HZSKVASTViewController *player;
...
@implementation HZSKVASTControls

- (id)initWithVASTPlayer:(HZSKVASTViewController *)vastPlayer
{
...
-(void)toggleToPlayButton:(BOOL)toggleToPlay
{
    @synchronized (self) {
        ...
        if (toggleToPlay) {  // show play button
            ...
            [HZSKLogger debug:@"VAST-Toolbar" withMessage:@"Toggle to playButton visible"];
            ...
            [HZSKLogger debug:@"VAST-Toolbar" withMessage:@"Toggle to pauseButton visible"];
        }
        [controlsToolbar setItems:toolbarButtons animated:NO];
    }
}
