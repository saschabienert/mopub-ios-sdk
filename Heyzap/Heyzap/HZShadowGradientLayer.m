...
@interface HZShadowGradientLayer()
- (void) commonInit;
@end

@implementation HZShadowGradientLayer
...
- (id) initWithLayer:(id)layer {
	...
	if (self) {
		[self commonInit];
		if([layer isKindOfClass:[HZShadowGradientLayer class]]) {
			HZShadowGradientLayer *other = (HZShadowGradientLayer*)layer;
