...
@implementation HZSKVASTMediaFilePicker
...
+ (HZSKVASTMediaFile *)pick:(NSArray *)mediaFiles
{
    ...
    NSArray *sortedMediaFiles = [compatibleMediaFiles sortedArrayUsingComparator:^NSComparisonResult(id a, id b) {
        HZSKVASTMediaFile *mf1 = (HZSKVASTMediaFile *)a;
        HZSKVASTMediaFile *mf2 = (HZSKVASTMediaFile *)b;
    ...
    for (int i = 0; i < len; i++) {
        int videoArea = ((HZSKVASTMediaFile *)sortedMediaFiles[i]).width * ((HZSKVASTMediaFile *)sortedMediaFiles[i]).height;
