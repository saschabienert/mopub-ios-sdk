...
@implementation HZKAProgressLabel {
    __unsafe_unretained HZTPPropertyAnimation *_currentAnimation;
}
                       ...
                       context:(void *)context
{
    ...
    if([keyPath isEqualToString:@"startDegree"] ||
       [keyPath isEqualToString:@"endDegree"]){
        ...
        HZKAProgressLabel *__unsafe_unretained weakSelf = self;
...
-(void)setStartDegree:(CGFloat)startDegree timing:(HZTPPropertyAnimationTiming)timing duration:(CGFloat)duration delay:(CGFloat)delay
{
    HZTPPropertyAnimation *animation = [HZTPPropertyAnimation propertyAnimationWithKeyPath:@"startDegree"];
...
-(void)setEndDegree:(CGFloat)endDegree timing:(HZTPPropertyAnimationTiming)timing duration:(CGFloat)duration delay:(CGFloat)delay
{
    HZTPPropertyAnimation *animation = [HZTPPropertyAnimation propertyAnimationWithKeyPath:@"endDegree"];
...
-(void)setProgress:(CGFloat)progress timing:(HZTPPropertyAnimationTiming)timing duration:(CGFloat)duration delay:(CGFloat)delay
{
